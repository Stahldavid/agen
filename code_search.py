...
#             results_dict_list = [vars(result) for result in results] 
#             results_string = json.dumps(results_dict_list)
#             results_list.append(results_string)
...
#     # Print directory name for debugging
...
# query = "variable impedance control"
# print(similarity_search(query, directories=['db_ros2_control']))
